...
<template>
  ...
  <span v-if="expr" @click="clickedHere">
    ...
    <!-- unary operators -->
    <span
      v-else-if="expr.e.tag === 'ExprUnary'"
      :style="style"
    ...
    >
      ...
      <span class="px-1">
        <FormattedExpr
          :expr="expr.e.e1"
          :widthLimit="unaryChildWidthLimit"
          @width="setEWidth"
    ...
    <!-- binary operators -->
    <span
      v-else-if="expr.e.tag === 'ExprBinary'"
      :style="style"
      :class="{
        'd-flex': true,
        'flex-column': !binaryFitsHorizontal,
        'align-items': true,
      }"
    >
      <span class="px-1">
        <FormattedExpr
          :expr="expr.e.e1"
          :widthLimit="binaryChildWidthLimit"
          @width="setE1Width"
          @click="(e) => emits('click', e)"
          :highlightedExpr="highlightedExpr"
        />
